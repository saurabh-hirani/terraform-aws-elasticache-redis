module "replication_group" {
  ...
  replication_group_id          = "redis-dtpr" //dtpr = cluster mode disabled + target primary and replica - short form due to name length constraints
