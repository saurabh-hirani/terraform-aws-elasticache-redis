module "replication_group" {
  ...
  replication_group_id          = "redis-dtp" //dtp = cluster mode disabled + target primary - short form due to name length constraints
